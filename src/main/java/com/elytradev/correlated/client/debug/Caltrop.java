...
public class Caltrop extends IRenderHandler {
	...
	public Caltrop(double x, double y, double z, float r, float g, float b, float width, float radius) {
		this.x = x;
		this.y = y;
		this.z = z;
		this.r = r;
