...
import io.github.elytra.copo.item.ItemDrive.PartitioningMode;
...
public class GuiDrive extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		if (priority.isMouseOver()) {
			List<String> li = Lists.newArrayList(
					I18n.format("gui.correlatedpotentialistics.priority"),
					pri.color+I18n.format("gui.correlatedpotentialistics.priority."+pri.lowerName)
					);
			drawHoveringText(li, mouseX, mouseY);
		}
		GlStateManager.popMatrix();
