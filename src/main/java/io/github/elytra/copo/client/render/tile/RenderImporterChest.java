...
public class RenderImporterChest extends TileEntitySpecialRenderer<TileEntityImporterChest> {

	private static final ResourceLocation TEXTURE = new ResourceLocation("correlatedpotentialistics", "textures/entity/importer_chest.png");
