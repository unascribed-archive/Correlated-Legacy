...
public class RSOD extends Program {
	...
	public void render(int rows, int cols) {
		...
		String key = "tooltip.correlatedpotentialistics.controller_error."+error;
		...
		if (IBMFontRenderer.canRender(errorLocal)) {
			...
			fr.drawString(errorLocal, (w/2)-(errLen/2), (h/2), CoPo.proxy.getColor("terminal", (parent.palette*4)+1));
